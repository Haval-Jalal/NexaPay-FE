    ...
    <Layout>
      <div className="max-w-4xl space-y-8">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          <h2 className="text-base font-semibold text-white mb-2">Skapa användare</h2>
          <p className="text-xs text-yellow-400 bg-yellow-400/10 border border-yellow-400/20 rounded-lg px-3 py-2 mb-5">
            Konton skapade här bekräftas automatiskt — e-postbekräftelse kringgås (<code className="font-mono">EmailConfirmed = true</code>).
          </p>
